...
metadata:
  ...
  version: "2.0"
  plugin-commands: "/bankruptcy-monitor"
  mcp-integrations: "qcc-company, qcc-risk, qcc-history, qcc-executive"
  industry: "Financial Services - Distressed Debt / Bankruptcy"
---
...
- 章节 1：**执行摘要 · 破产预警 Decision Pack**（预警级别 + 破产概率 + 重整/清算预判 + T+0/T+3/T+7 Action）
- 章节 2：数据来源与互证方法
- 章节 3：被监控主体基本信息
- 章节 4：**7 大破产先行指标扫描结果**
- 章节 5：正式破产程序状态（如已进入）
